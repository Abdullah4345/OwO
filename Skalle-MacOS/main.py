...
class VolatilityAnalyzer:
    ...
    def load_volatility_path(self):
        csv_path = resource_path(os.path.join("data", "vol_path.csv"))
    ...
    def create_widgets(self):
        ...
        style.configure("Black.TNotebook.Tab",
                        background="#000", foreground="#ff4444",
                        font=("Courier", 12, "bold"),
                        lightcolor="#000", borderwidth=0, padding=10)
        ...
        tk.Label(info_frame, text="Memory Dump:", font=("Courier", 12, "bold"),
                 fg="#ff4444", bg="#000").grid(row=0, column=0, sticky=tk.W)
        self.dump_entry = tk.Entry(
            info_frame, width=50, bg="#000", fg="#ff4444", insertbackground="#ff4444", font=("Courier", 12))
        ...
        tk.Label(info_frame, text="Volatility Path:", font=(
            "Courier", 12, "bold"), fg="#ff4444", bg="#000").grid(row=1, column=0, sticky=tk.W)
        ...
        tk.Label(options_frame, text="Select:", font=("Courier", 12, "bold"),
        ...
        self.plugin_combobox = ttk.Combobox(
            ...
            state="readonly", style="Black.TCombobox", width=25, font=("Courier", 12))
        ...
        tk.Label(options_frame, text="Custom Plugin:", font=("Courier", 12),
                 fg="#ff4444", bg="#000").grid(row=1, column=0, sticky=tk.W, padx=(0, 5), pady=(8, 0))
        self.custom_cmd = tk.Entry(
            options_frame, width=25, bg="#000", fg="#ff4444", insertbackground="#ff4444", font=("Courier", 12))
...
""", font=("Courier", 4, "bold"),
        ...
        tk.Label(search_frame, text="Search Output:", font=(
            "Courier", 12), fg="#ff4444", bg="#000").pack(side=tk.LEFT)
        self.search_entry = tk.Entry(
            search_frame, width=30, bg="#000", fg="#ff4444", insertbackground="#ff4444", font=("Courier", 12))
        ...
        tk.Label(self.root, textvariable=self.status_var, relief=tk.SUNKEN,
                 anchor="w", bg="#000", fg="#ff4444", font=("Courier", 11),
    ...
    def _list_plugins_thread(self):
        try:
            ...
            result = subprocess.run(
                [self.volatility_path, "--help"], capture_output=True, text=True)
            if result.returncode == 0:
    ...
    def validate_volatility(self):
        if not self.volatility_path:
            ...
            return False
        try:
            subprocess.run([self.volatility_path, "--help"],
                           stdout=subprocess.PIPE, stderr=subprocess.PIPE)
            return True
        except:
            messagebox.showerror(
